...
import { useAiAssistantModal } from "@/features/ai-assistant/store/use-ai-assistant-modal";
...
export const WorkSpaceSidebar = () => {
  ...
  const { setOpen: setAiOpen } = useAiAssistantModal();
        ...
        >
          {voiceChannels?.map((item) => (
            <SideBarItem
              ...
              icon={PhoneCall}
              id={item._id}
              href={`/workspaces/${workspaceId}/voice-channels/${item._id}?join=1`}
              variant={
